        ...
        <div className="solar__specs__container">
          ...
          >
            ...
            <div className="solar__specs__container__specs__details">
              <SpecsDeatilsItem title="Wattage" specs={solar.wattage} />
              <SpecsDeatilsItem
                title="Operating Temperature"
                specs={solar.temperature}
              />
              <SpecsDeatilsItem title="Dimensions" specs={solar.dimensions} />
              <SpecsDeatilsItem title="Design" specs={solar.design} />
              <SpecsDeatilsItem title="Warranty" specs={solar.warranty} />
              <SpecsDeatilsItem
                title="Certifications"
                specs={solar.certification}
              />
              <SpecsDeatilsItem title="Inverter Power" specs={solar.power} />
              <SpecsDeatilsItem title="Fire Rating" specs={solar.fire} />
            </div>
          </motion.div>
        </div>
      </div>
